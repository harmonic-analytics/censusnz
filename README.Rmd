...
The package includes a vignettes detailing the use of the provided functions.
  To view this vignette run the following after installing the package:
```{r eval = FALSE}
vignette("example_01", package = "censusnz")
```
