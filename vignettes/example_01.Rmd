...
Maybe we try plotting the data by `RC` unit, for Regional Councils.
...
example, we can see that Auckland region has more individuals who have never
smoked than the Total NZ average, and Wellington has a relatively smaller
